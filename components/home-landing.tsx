  ...
  return (
    <main className="overflow-x-hidden">
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-4">
              <Link href="/products" className="w-full md:w-auto text-center rounded-md bg-accent px-7 py-3.5 text-sm font-semibold text-white hover:bg-blue-500">
                Explore Products
              </Link>
              <Link href="/contact" className="w-full md:w-auto text-center rounded-md border border-slate-700 px-6 py-3 text-sm font-medium text-slate-300 hover:border-slate-500">
                Contact Engineering
              </Link>
            </div>
      ...
      <section className="section-container section-spacing border-t border-slate-800">
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-3">
          <article className="rounded-xl border border-slate-800 bg-surface p-6 transition hover:scale-[1.02] hover:border-slate-500">
            ...
            <Link href="/products" className="mt-4 inline-block text-sm text-blue-300 hover:text-blue-200">
              Explore Products
            </Link>
          </article>
          <article className="rounded-xl border border-slate-800 bg-surface p-6 transition hover:scale-[1.02] hover:border-slate-500">
          ...
          <article className="rounded-xl border border-slate-800 bg-surface p-6 transition hover:scale-[1.02] hover:border-slate-500">
            ...
            <Link href="/thruster" className="mt-4 inline-block text-sm text-blue-300 hover:text-blue-200">
      ...
      <section className="section-container section-spacing border-t border-slate-800">
        ...
        <Link href="/products" className="mt-8 inline-block w-full md:w-auto rounded-md bg-accent px-6 py-3 text-center text-sm font-semibold text-white hover:bg-blue-500">
          Explore Products
        </Link>
      </section>
      ...
      <section className="section-container section-spacing border-t border-slate-800">
        ...
        <div className="mt-8 rounded-xl border border-slate-700 bg-surface p-6">
          ...
          <Link href="/thruster" className="mt-6 inline-block rounded-md bg-accent px-6 py-3 text-sm font-semibold text-white hover:bg-blue-500">
            Explore Thruster Control
          </Link>
        </div>
      </section>
